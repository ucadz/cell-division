...
const imageDescriptions = {
    ...
    "Centrosome-S": "Duplicates during S-phase. The two centrioles separate and serve as templates for the formation of new daughter centrioles.",
    "Chromatin-S": "The primary function of chromatin in the S phase is to facilitate the accurate replication of DNA. Each chromosome is duplicated, resulting in two sister chromatids.",
    "Nucleolus": "continues to synthesize ribosomal RNA (rRNA) and assemble ribosomal subunits, which are essential for protein synthesis.",
    "Nucleus": "The primary function of the nucleus during S phase is the replication of DNA. The nuclear envelope remains intact throughout the S phase, providing a controlled environment for the DNA replication process."
};
...
function combine() {
    const correctOrder = ['Cell', 'Nucleus', 'Centrosome-S', 'Chromatin-S', 'Nucleolus'];
...
function showModalWithDescription() {
    ...
    modalContent.innerHTML = `
        <span id="close-modal" style="cursor: pointer; float: right;">&times;</span>
        <img src="G2-Phase.png" alt="S-Phase" style="width: 100%; height: auto;">
        <p>Congratulations! You've correctly ordered the phases!</p>
        <p>${g1PhaseDescription}</p>
        <a href="UnlockG2phase.html" style="text-decoration: none;" onclick="markLevelComplete('level1')">
