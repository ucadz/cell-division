document.addEventListener('DOMContentLoaded', () => {
    ...
    const game4Btn = document.getElementById('game4Btn'); // Corrected variable name
    ...
    const closeInstructionsBtnGame3 = document.getElementById("closeInstructionsBtn3");
    ...
    okayBtnGame3.addEventListener("click", () => {
        ...
        window.location.href = "Cytokinesis.html"; // Redirect to the puzzle page (change as needed)
    });
